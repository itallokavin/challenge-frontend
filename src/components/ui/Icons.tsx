export class Icons{
    ...
    CloseIcon = (props: React.SVGProps<SVGSVGElement>) => (
    ...
    EditIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const IconComponent = new Icons();